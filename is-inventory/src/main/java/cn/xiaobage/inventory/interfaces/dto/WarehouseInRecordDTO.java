...
public class WarehouseInRecordDTO {
    ...
    @ApiModelProperty(name = "id", value = "入库单id")
    private Long id;

    @ApiModelProperty(name = "recordCode", value = "入库单编码")
    ...
    @ApiModelProperty(name = "quantity", value = "产品入库数量")
    ...
    @ApiModelProperty(name = "timeOfMaking", value = "入库单制作时间")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss",timezone = "GMT+8")
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private Date timeOfMaking;

    @ApiModelProperty(name = "maker", value = "入库单制作人")
